...
describe('quoted values', () => {
  ...
  test('quote type any', () => {
    ...
    check('---\n' +
          ...
          conf, RULE_ID,
          { problem1: [4, 10], problem2: [17, 5], problem3: [19, 12],
  ...
  test('quote type single', () => {
    ...
    check('---\n' +
          ...
          'nested-flow2: [{a: foo}, {b: "foo,bar", c: ["d[e]"]}]\n',
          conf, RULE_ID,
          { problem1: [4, 10], problem2: [5, 10], problem3: [6, 10],
    ...
    check('---\n' +
          ...
          '  "word 1\\\n' +
          '   word 2"\n',
          conf, RULE_ID, { problem1: [9, 3], problem2: [12, 3], problem3: [15, 3] });
  });
  ...
  test('quote type double', () => {
    ...
    check('---\n' +
          ...
          'nested-flow2: [{a: foo}, {b: "foo,bar", c: ["d[e]"]}]\n',
          conf, RULE_ID,
          { problem1: [4, 10], problem2: [8, 10], problem3: [17, 5],
  ...
  test('single quotes not required', () => {
    ...
    check('---\n' +
          ...
          'nested-flow2: [{a: foo}, {b: "foo,bar", c: ["d[e]"]}]\n',
          conf, RULE_ID,
          { problem1: [5, 10], problem2: [6, 10], problem3: [7, 10],
    ...
    check('---\n' +
          ...
          '  "word 1\\\n' +
          '   word 2"\n',
          conf, RULE_ID, { problem1: [12, 3], problem2: [15, 3] });
  });
  ...
  test('only when needed', () => {
    ...
    check('---\n' +
          ...
          'nested-flow2: [{a: foo}, {b: "foo,bar", c: ["d[e]"]}]\n',
          conf, RULE_ID,
          { problem1: [5, 10], problem2: [8, 10], problem3: [18, 5],
  ...
  test('only when needed corner cases', () => {
    ...
    check('---\n' +
          ...
          '- :wq\n' +
          '- ":wq"\n',
          conf, RULE_ID, { problem1: [3, 3], problem2: [5, 3], problem3: [7, 3] });
    check('---\n' +
          'k1: ---\n' +
          'k2: "---"\n' +
          'k3: ----------\n' +
          ...
          'k5: :wq\n' +
          'k6: ":wq"\n',
          conf, RULE_ID, { problem1: [3, 5], problem2: [5, 5], problem3: [7, 5] });
  });
  ...
  test('only when needed extras', () => {
    ...
    check('---\n' +
          ...
          '- ftp://localhost\n' +
          '- "ftp://localhost"\n',
          conf, RULE_ID, { problem1: [4, 3], problem2: [6, 3], problem3: [8, 3] });

    const conf2 = ('quoted-strings:\n' +
                   '  required: only-when-needed\n' +
                   '  extra-allowed: [^ftp://]\n' +
                   '  extra-required: [^http://]\n');
    check('---\n' +
          ...
          '- ftp://localhost\n' +
          '- "ftp://localhost"\n',
          conf2, RULE_ID, { problem1: [5, 3], problem2: [6, 3] });

    const conf3 = ('quoted-strings:\n' +
                   '  required: false\n' +
    ...
    check('---\n' +
          ...
          '- ftp://localhost\n' +
          '- "ftp://localhost"\n',
          conf3, RULE_ID, { problem1: [6, 3], problem2: [8, 3] });

    const conf4 = ('quoted-strings:\n' +
                   '  required: only-when-needed\n' +
                   '  extra-allowed: [^ftp://, ";$", " "]\n');
    check('---\n' +
          '- localhost\n' +
          ...
          '- foo bar\n' +
          '- "foo bar"\n',
          conf4, RULE_ID, { problem1: [3, 3], problem2: [7, 3], problem3: [11, 3] });
  });
  ...
  test('octal values', () => {
    ...
    check('---\n' +
          ...
          '- "0800"\n' +
          '- "0o800"\n',
          conf, RULE_ID, { problem1: [9, 3], problem2: [10, 3] });
  });

  test('allow quoted quotes', () => {
    let conf = ('quoted-strings: {quote-type: single,\n' +
                '                 required: false,\n' +
                '                 allow-quoted-quotes: false}\n');
    check('---\n' +
          'foo1: "[barbaz]"\n' +
          "foo2: \"[bar'baz]\"\n",
          conf, RULE_ID, { problem1: [2, 7], problem2: [3, 7] });
...
describe('quoted keys', () => {
  ...
  test('default', () => {
    ...
    check(keyStrings, confDefault, RULE_ID,
          { problem1: [4, 1], problem3: [20, 3], problem4: [23, 2], problem5: [33, 3] });
  });
  ...
  test('quote type any', () => {
    ...
    check(keyStrings, conf, RULE_ID,
          { problem1: [4, 1], problem2: [20, 3], problem3: [23, 2], problem4: [33, 3] });
  });
  ...
  test('only when needed corner cases', () => {
    ...
    check('---\n' +
          ...
          ':wq: 6\n' +
          '":cw": 7\n',
          conf, RULE_ID, { problem1: [3, 1], problem2: [5, 1], problem3: [7, 1] });
  });
  ...
  test('octal values', () => {
    ...
    check('---\n' +
          ...
          '"0900": 11\n' +
          '"0o900": 12\n',
          conf, RULE_ID, { problem1: [9, 1], problem2: [10, 1] });
  });
});
